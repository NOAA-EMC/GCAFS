...
FV3_predet(){
  ...
  # nasa GOCART
  ${NCP} "${FIXgfs}/lut/optics_luts_DUST_nasa.dat"  "${DATA}/optics_luts_DUST_nasa.dat"
  ${NCP} "${FIXgfs}/lut/optics_luts_SALT_nasa.dat"  "${DATA}/optics_luts_SALT_nasa.dat"
  ${NCP} "${FIXgfs}/lut/optics_luts_SOOT_nasa.dat"  "${DATA}/optics_luts_SOOT_nasa.dat"
  ${NCP} "${FIXgfs}/lut/optics_luts_SUSO_nasa.dat"  "${DATA}/optics_luts_SUSO_nasa.dat"
  ${NCP} "${FIXgfs}/lut/optics_luts_WASO_nasa.dat"  "${DATA}/optics_luts_WASO_nasa.dat"
  ${NCP} "${FIXgfs}/lut/optics_luts_NITR_nasa.dat"  "${DATA}/optics_luts_NITR_nasa.dat"
...
#    ${NCP} "${PARMgfs}/ufs/post_itag_gfs"                         "${DATA}/itag"  # TODO: Need a GEFS version when available in the UFS-weather-model
    ${NCP} "${PARMgfs}/ufs/post_tag_gfs128"                         "${DATA}/itag"  # TODO: Need a GEFS version when available in the UFS-weather-model
...
#        ${NCP} "${PARMgfs}/post/gfs/postxconfig-NT-gfs-f00-two.txt" "${DATA}/postxconfig-NT_FH00.txt"
        ${NCP} "${PARMgfs}/post/gfs/postxconfig-NT-UFS-aerosol.txt"     "${DATA}/postxconfig-NT.txt"
        ${NCP} "${PARMgfs}/post/gfs/postxconfig-NT-UFS-aerosol-F00.txt" "${DATA}/postxconfig-NT_FH00.txt"
        ;;
      gefs)
