...
def main():
    ...
    # steps
    keys = ['ATARDIR', 'current_cycle', 'FHMIN', 'FHMAX', 'FHOUT', 'RUN',
            'PDY', 'DO_VERFRAD', 'DO_VMINMON', 'DO_VERFOZN', 'DO_ICE',
            'DO_PREP_OBS_AERO', 'PARMgfs', 'DO_OCN', 'DO_WAVE',
            'WRITE_DOPOST', 'PSLOT', 'DO_MOS', 'DO_JEDISNOWDA', 'DO_ARCHCOM',
            'ARCHCOM_TO', 'REALTIME', 'ROTDIR', 'ARCH_WARMICFREQ',
            ...
            'DO_BUFRSND', 'DOHYBVAR', 'ARCH_GAUSSIAN_FHMAX',
            'ARCH_GAUSSIAN_FHINC', 'ARCH_GAUSSIAN_FHINC', 'DOIAU', 'OCNRES',
            'ICERES', 'NUM_SND_COLLECTIVES', 'FHOUT_WAV', 'FHOUT_HF_WAV',
            'FHMAX_WAV', 'FHMAX_HF_WAV', 'FHMAX_WAV_GFS',
            'restart_interval_gdas', 'restart_interval_gfs', 'DO_ARCHCOM',
            'DO_AERO_ANL', 'DO_AERO_FCST', 'DO_CA', 'DOIBP_WAV',
            'DO_JEDIOCNVAR', 'DOHYBVAR_OCN', 'DOLETKF_OCN', 'NMEM_ENS',
            'DO_JEDIATMVAR', 'FHMAX_FITS', 'waveGRD', 'IAUFHRS', 'DO_FIT2OBS',
            'NET', 'FHOUT_HF_GFS', 'FHMAX_HF_GFS', 'REPLAY_ICS',
            'OFFSET_START_HOUR', 'ARCH_EXPDIR', 'EXPDIR', 'ARCH_EXPDIR_FREQ',
            'ARCH_HASHES', 'ARCH_DIFFS', 'SDATE', 'EDATE', 'HOMEgfs',
            'DO_GEMPAK', 'DATASETS_YAML', 'WAVE_OUT_GRIDS']
